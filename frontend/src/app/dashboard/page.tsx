...
export default function DashboardPage() {
  return <div className="p-6 space-y-4">
    ...
    <p className="text-sm text-amber-300">This tool is for personal research and paper trading only. It does not provide financial advice or guaranteed predictions.</p>
    ...
    <div className="grid grid-cols-3 gap-4">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded p-4">Open paper trades: missing</div>
    </div>
